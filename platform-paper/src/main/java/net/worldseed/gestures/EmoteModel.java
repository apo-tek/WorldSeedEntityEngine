...
public class EmoteModel extends GenericModelImpl {
    ...
    public boolean addViewer(@NotNull Player player) {
        System.out.println("Adding viewer " + player.getName());
        return super.addViewer(player);
    }

    @Override
    public boolean removeViewer(@NotNull Player player) {
        System.out.println("Removing viewer " + player.getName());
    ...
    private void init_(World world, @NotNull Pos position) {
