...
public interface Viewable {
     ...
     */
    default void sendPacketToViewers(Packet<?> packet) {
        getViewers().forEach(player -> ((CraftPlayer) player).getHandle().connection.send(packet));
    }

    default void sendPacketsToViewers(Collection<Packet<?>> packets) {
        packets.forEach(this::sendPacketToViewers);
    }

    default void sendPacketsToViewers(Packet<?>... packets) {
     ...
     */
    default void sendPacketToViewersAndSelf(Packet<?> packet) {
